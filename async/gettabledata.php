<?php
    ...
    class Basic_GetTableData_AsyncAction extends Basic_Abstract_AsyncAction
    {
        ...
        public function perform($_domainId = null, array $_params = array())
        {
            ...
            foreach ($tabledata as $key2 => $value2) {
                $date = date_create($tabledata[$key2]['date'])->Format('m/d/Y');
                $tabledata[$key2]['formatsdate'] = $date;
            }
