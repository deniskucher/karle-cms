<?php
    ...
    class Basic_CreateNews_AsyncAction extends Basic_Abstract_AsyncAction
    {
        /**
         * Performs the action
         */
        public function perform($_domainId = null, array $_params = array())
        {
            ...
            if ($flag) {throw new AsyncActionException($json);}
                ...
                $mySql->insert('news', array('subject' => $subject, 'subject_en' => $subjecten, 'content' => $content, 'content_en'=>$contenten, 'domain_id' => $_domainId));
            }
            $newsid = $mySql->getInsertId();
